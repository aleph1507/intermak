            ...
            <div class="panel panel-default form-spacing-top">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group">
                            <label for="creditcard" class="col-md-4 control-label">Credit Card</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control" id="ccno" name="creditcard">
                            </div>
                        </div>
                    ...
                    <script>
                        $(function() {
                            $('#ccno').validateCreditCard(function(result) {
                                $('.logcc').html((result.card_type == null ? 'Invalid Credit Card' : ""));
                            });
                        });
                    </script>
                </div>
